     ...
     <div className='flex justify-center items-center h-screen'>
        ...
        <div className='flex justify-center w-full'>
            <div className='flex flex-col justify-center items-center w-full'>
                ...
                <input className='text-xl border border-gray-500 text-gray-800 font-bold rounded-lg w-2/3 px-5 py-4 mt-10' placeholder='Enter Mobile Number'/>
                <button className='text-2xl border border-none bg-teal-500 text-white font-sans font-semibold rounded-lg w-2/3 px-5 py-3 m-3'>
                    CONTINUE
                </button>
