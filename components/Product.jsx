...
import { responsive, responsive_third } from "./ResponsiveFeatures"
    ...
    const fetchData = async () => {
      try {
        ...
        const similarProducts = await axios.get(
          `https://backend.gezeno.in/api/productOfCategory/${productDetails?.data?.category}`,
        )
        console.log("details",productDetails?.data)
                        ...
                        <div className="flex flex-wrap gap-2">
                          {distinctTags.map((tag) => (
                            <Button
                              ...
                              className={cn(
                                "px-4 h-12",
                                selectedFilters[filterGroup.filter.name]?.includes(tag) &&
              ...
              <div>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-left">
                        <div className="font-bold md:text-xl  text-sm">Offers</div>
                        <div className="text-muted-foreground text-md">Save Extra With 2 Offers</div>
                      </div>
                    </div>
                ...
                <div className="border-b p-5">
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-left">
                        <div className="font-bold md:text-xl  text-sm">Product Description</div>
                    ...
                    >
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <br />
                          Sairaj logistic hub #A5, BMC pipeline road, Opposite all saints high school,
                          <br />
                        ...
                        <div>
                          ...
                          <ul className="list-disc pl-5 space-y-2">
                            ...
                            <li>
                              60% Cotton, 40% Poly - Midweight fleece comprising 60% Cotton & 40% Poly - soft and sturdy
                              for maximum comfort.
                            </li>
                          </ul>
                        </div>
                ...
                <div className="border-b p-5">
                  ...
                  {isReturnsOpen && (
                    ...
                    >
                      <p>
                        Easy 15 days return and exchange. Return Policies may vary based on products and promotions.
                      </p>
                      <ul className="list-disc pl-5 space-y-2">
          ...
          <div className="mt-16 space-y-6 max-w-6xl mx-auto">
            ...
            >
              {relatedProducts.map((product) => (
                <div
                  key={product._id}
                  className="group cursor-pointer relative m-2"
